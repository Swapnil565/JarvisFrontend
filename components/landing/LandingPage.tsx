...
const NeuralCortex = dynamic(() => import('@/components/VisualCore/NeuralCortex'), { ssr: false });
...
export const LandingPage = () => {
  ...
  return (
    <CursorContext.Provider value={{ variant: cursorVariant, setVariant: setCursorVariant }}>
      ...
      {/* Top Nav Bar */}
      <nav className="fixed top-0 left-0 right-0 z-[1000] flex items-center justify-between px-8 py-4 bg-[#0A1929]/80 backdrop-blur-md border-b border-white/5">
        <a
          href={process.env.NEXT_PUBLIC_LANDING_URL || 'http://localhost:3000'}
          className="flex items-center gap-2 text-[#94A3B8] hover:text-[#00D9FF] transition-colors duration-200 font-mono text-sm tracking-wider group"
        >
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono text-xs text-[#00D9FF] tracking-widest">JARVIS ONLINE</span>
        </div>
      </nav>
